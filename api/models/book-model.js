...
class BookModel {
    ...
    createBook(category, book) {
         //Add the received book to the given category in the model

        this.addBook(category, book);
        return book;
    }

    updateBook(id, book) {
        //Update the book with the given id in the model

        const update = this.getBook(id); 
    ...
    deleteBook(id) {
        //Delete the book with the given id from the model
        ...
        if(category) {
            removed = this.books.get(category).delete(id);
        }
...
model.addBook(html5Category, new Book("Responsive Web Design with HTML 5 & CSS", "images/Responsive_web_design.jpg", 34.98,
"Equipping you with the most up-to-date tools available, Minnick's RESPONSIVE WEB DESIGN WITH HTML 5 & CSS, 9th edition, teaches you step by step how to design professional quality websites that attract and retain customers.", "978-0357423837"));
model.addBook(html5Category, new Book("New Perspectives on HTML 5 and CSS: Comprehensive: Comprehensive", "images/Html5_and_css.jpg", 30.93,
"Develop the skills you need to compete successfully in today's high-tech workforce with Carey's NEW PERSPECTIVES ON HTML5 AND CSS3: COMPREHENSIVE, 8E and MindTap digital resources. You learn fundamental design concepts as you build websites based on real-world case scenarios.", "978-0357107140"));
...
model.addBook(jsCategory, new Book("JavaScript: The Definitive Guide", "images/JavaScript_The_Definitive_Guide.jpg", 47.30,
...
model.addBook(jsCategory, new Book("JavaScript: The Good Parts", "images/JavaScript_The_Good_Parts.jpg", 23.90,
...
model.addBook(jsCategory, new Book("Eloquent JavaScript, 3rd Edition: A Modern Introduction to Programming", "images/Eloquent_javascript.jpg", 18.99,
    "JavaScript lies at the heart of almost every modern web application, from social apps like Twitter to browser-based game frameworks like Phaser and Babylon. Though simple for beginners to pick up and play with, JavaScript is a flexible, complex language that you can use to build full-scale applications. programming languages contain good and bad parts, but JavaScript has more than its share of the bad, having been developed and released in a hurry before it could be refined.", "978-1593279509"));
model.addBook(jsCategory, new Book("JavaScript from Beginner to Professional: Learn JavaScript quickly by building fun, interactive, and dynamic web apps, games, and pages", "images/Js_Beginner2Professioanl.jpg", 34.71,
    "This book demonstrates the capabilities of JavaScript for web application development by combining theoretical learning with code exercises and fun projects that you can challenge yourself with. The guiding principle of the book is to show how straightforward JavaScript techniques can be used to make web apps ranging from dynamic websites to simple browser-based games. Fifth Edition is completely revised and expanded to cover JavaScript as it is used in today's Web 2.0 applications.", "978-1800562523"));
